...
export const metadata = {
  title: 'Getting Started',
  description:
    'Start your journey with ChainL by learning the basics of the course.',
}

# Welcome to ChainLab

This section will introduce you to the basics of our course and guide you through your first steps in ChainLab.
