...
description: Deploy your first smart contract on the ChainLab Testnet blockchain.
---
...
In this guide, you'll deploy your first smart contract on the `ChainLab Testnet` blockchain. Before you begin, ensure you've completed the following checklist:
