...
export const metadata = {
  title: 'Install and connect wallet',
  description:
    'Learn how to install the necessary tools and connect your wallet to the ChainLab Testnet network.',
}
...
Connecting your wallet to the ChainLab Testnet network is a straightforward process. Simply click the button below to get started:
...
> [!tip]
> You can use the following network information to connect your wallet to the ChainLab Testnet network.
