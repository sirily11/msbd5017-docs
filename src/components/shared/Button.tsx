...
const variantStyles = {
  ...
  filled:
    'rounded-lg bg-zinc-900 py-1 px-3 text-white hover:bg-zinc-700 dark:bg-emerald-500 dark:text-white dark:hover:bg-emerald-400',
  outline:
...
export function Button({
  ...
  className = clsx(
    'inline-flex gap-0.5 justify-center overflow-hidden text-sm font-medium transition disabled:opacity-50 disabled:cursor-not-allowed',
